...
2. 수정 대상이 Work 리스트라면 이력서에 등장하는 프로젝트만 우선 적용한다: `MMIS/AI Harness` 계열, `RedClick`, `Location`, `AmazonCar`, `Yummy Game`, 이후 `Zudice`, `Entropy Explorer`, `Fruttidino` 같은 과거 Web3/Game 프로젝트.
